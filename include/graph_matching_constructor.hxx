#ifndef LP_MP_GRAPH_MATCHING_CONSTRUCTOR_HXX
#define LP_MP_GRAPH_MATCHING_CONSTRUCTOR_HXX
...
protected:
   ...
   void construct_pairwise_factors(MRF_CONSTRUCTOR& mrf, const REAL scaling, std::vector<std::vector<std::size_t>>& graph)
   {
       for(const auto& q : quadratic_) {
           ...
           f->GetFactor()->cost(index_1, index_2) = scaling*q.cost; 
       } 
   }
...
#endif // LP_MP_GRAPH_MATCHING_CONSTRUCTOR_HXX
